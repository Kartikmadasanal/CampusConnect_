...
export default function DashComments() {
  ...
  const fetchComments = async (e) => {
    ...
    try {
      const res = await axios.get(URL+'/api/comments/'+`?search=${prompt}`);
  ...
  const handleDeleteComment = async () => {
    setShowModal(false);
    try {
      await axios.delete(`${URL}/api/comments/${commentIdToDelete}`, {
          headers: {
        ...
        <>
          <Table hoverable className='shadow-md'>
            <Table.Head>
              ...
              <Table.HeadCell>Comment Writer</Table.HeadCell>
